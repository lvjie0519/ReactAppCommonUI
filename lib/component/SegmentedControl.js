...
export default class SegmentedControl extends Component{
    ...
    static get getDefaultProps(){
        return {
            ...
            segmentedControlStyle:{
                borderColor:'#38adff',              // 边框颜色
                selectSegmentColor:'#38adff',       // 选中段的颜色
                unselectSegmentColor:'#ffffff',     // 未选中段的颜色
                selectTextColor:'#ffffff',          // 选中字体的颜色
                unSelectTextColor: '#38adff',       // 未选中字体的颜色
                fontSize: 14,                       // 字体的大小
            }
        };
    }
    ...
    render(){
        ...
        if(len == 0){
            ...
            return(
                <View>
                    <View style={[styles.warpView, {width:76*len+1}, {borderColor: segStyle.borderColor, height: height}]}>
                        {content}
                    </View>
                </View>
    ...
    getStyleFromUserStyle(){
        ...
        segStyle.borderColor = userStyle.borderColor == null?'#38adff':userStyle.borderColor;
        segStyle.selectSegmentColor = userStyle.selectSegmentColor == null?'#38adff':userStyle.selectSegmentColor;
        segStyle.unselectSegmentColor = userStyle.unselectSegmentColor == null?'#ffffff':userStyle.unselectSegmentColor;
        segStyle.selectTextColor = userStyle.selectTextColor == null?'#ffffff':userStyle.selectTextColor;
        segStyle.unSelectTextColor = userStyle.unSelectTextColor == null?'#38adff':userStyle.unSelectTextColor;
        segStyle.fontSize = userStyle.fontSize == null?14:userStyle.fontSize;
...
const styles = StyleSheet.create({
    ...
    divideLine:{
        height:30,
        width: isIOS?StyleSheet.hairlineWidth:1,
        backgroundColor:'#38adff',
    }
})